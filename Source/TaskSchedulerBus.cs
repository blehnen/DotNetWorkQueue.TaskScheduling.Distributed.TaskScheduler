    ...
    internal class TaskSchedulerBus: ITaskSchedulerBus
    {
        ...
        private void RunActor(PairSocket shim)
        {
            ...
            using (_beacon = new NetMQBeacon())
            {
                ...
                _log.BusSubscriberBound(_subscriber.Options.LastEndpoint);
